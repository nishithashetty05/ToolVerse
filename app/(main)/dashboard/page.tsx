    ...
    <div className="space-y-6 animate-in slide-in-from-bottom-4 duration-500 fade-in">
      ...
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400">
          Manage your tools, reservations, and activities.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div
            key={idx}
            className="bg-card-bg p-6 rounded-2xl border border-card-border shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow"
          >
          ...
          <div className="space-y-6">
            ...
            {loading && (
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {[...Array(4)].map((_, i) => (
                  <div
                    key={i}
                    className="bg-card-bg rounded-2xl border border-card-border h-72 animate-pulse"
                  />
                ))}
              </div>
            )}
            ...
            {!loading && error && (
              <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-800 rounded-xl p-4 text-red-600 dark:text-red-400 text-sm">
                {error} — check your DATABASE_URL in .env and make sure PostgreSQL is running.
              </div>
            )}
            ...
            {!myLoading && myTools.length === 0 && !showAddForm && (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-gray-500 max-w-md mx-auto mb-6">
                  List your unused agricultural equipment and start earning by
        ...
        {["activity", "maintenance", "experts"].includes(currentTab) && (
          <div className="bg-card-muted border border-card-border rounded-2xl p-12 text-center">
            ...
            <p className="text-gray-500">
              The {tabs.find((t) => t.id === currentTab)?.label} feature is
