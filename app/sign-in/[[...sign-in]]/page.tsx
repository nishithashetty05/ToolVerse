      ...
      <div className="max-w-5xl w-full bg-white dark:bg-card-bg rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row min-h-[600px] animate-in fade-in zoom-in-95 duration-500">
        ...
        <div className="w-full md:w-5/12 bg-primary p-10 flex flex-col justify-between text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight">Your Gateway to Smarter Farming</h1>
            <p className="text-green-50 mb-8 text-sm leading-relaxed">
              Access a community of farmers sharing tools, knowledge, and expertise to grow together sustainably.
            </p>
          ...
          <div className="relative z-10 bg-white/10 p-4 rounded-xl border border-white/20 backdrop-blur-sm">
             <div className="flex gap-2">
               ...
               <p className="text-xs italic text-green-50 leading-relaxed">
                 "FarmShare helped our cooperative reduce equipment costs by 60%." <br/>
                 <span className="font-semibold block mt-1">— Farm Cooperative of CA</span>
               </p>
             </div>
          </div>
        </div>
